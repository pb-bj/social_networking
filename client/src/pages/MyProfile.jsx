    ...
    <div>
      <div className="feedContainer bg-slate-100 flex flex-col md:flex-row  ">
        <div className="feedLeft flex flex-col items-center w-full md:w-[57%] ">
          ...
          <div className="FriendReq hidden md:block my-10 w-[300px] h-[210px] py-9 px-7 rounded-md bg-white">
        ...
        <div className="feedCenter w-full flex flex-col items-center mt-12 ">
          {/* Post */}
          <div className="posts  flex flex-col py-10 px-7 bg-white w-full h-[700px]">
            {" "}
            ...
            <div className="postdesc mt-2 ">
              ...
              recusandae ea maiores facere unde iste! Reprehenderit officia esse
              sed a. Optio sequi accusamus fugiat dolor nesciunt quaerat eos,
              voluptates possimus ...
            </div>
        ...
        {/* Feed right */}
        <div className="feedRight flex flex-col items-center w-full md:w-[50%]"></div>
      </div>
    </div>
  );
}
